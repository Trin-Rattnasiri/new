    ...
    <div className="min-h-screen bg-white flex flex-col items-center pb-10 px-2">
      ...
      <Dialog open={showLogoutDialog} onOpenChange={setShowLogoutDialog}>
        <DialogContent className="sm:max-w-md">
          ...
          <DialogHeader><DialogTitle className="flex items-center gap-2 text-blue-700">
            <AlertCircle className="h-5 w-5 text-blue-500" />ยืนยันการออกจากระบบ
          </DialogTitle></DialogHeader>
          <DialogFooter className="sm:justify-center gap-2">
            ...
            <Button type="button" onClick={handleLogout} disabled={isLoggingOut} className="bg-blue-600 hover:bg-blue-700 text-white">
