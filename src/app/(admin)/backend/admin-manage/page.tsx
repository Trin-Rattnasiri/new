        ...
        <CardHeader className="bg-white border-b">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-2xl font-bold text-gray-900">จัดการผู้ดูแลระบบ</CardTitle>
                <CardDescription className="text-gray-700">เพิ่ม แก้ไข หรือลบผู้ดูแลระบบ</CardDescription>
              </div>
            </div>
