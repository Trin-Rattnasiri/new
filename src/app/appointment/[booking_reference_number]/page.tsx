...
export default function AppointmentPage() {
  ...
  <div className="flex items-start gap-3">
    ...
    <div>
      <p className="text-sm text-gray-600 font-semibold">HN</p>
      <p className="text-base text-gray-800">{data.hn}</p>
    </div>
  </div>
  ...
  <div className="flex items-start gap-3">
    ...
    <div>
      <p className="text-sm text-gray-600 font-semibold">วันที่นัด</p>
      <p className="text-base text-gray-800">
        {format(parseISO(data.slot_date), "EEEEที่ d MMMM yyyy", { locale: th })} ({data.start_time.slice(0, 5)} - {data.end_time.slice(0, 5)})
      </p>
    </div>
  </div>
  ...
  <div className="flex items-start gap-3">
    <FileText className="h-5 w-5 text-sky-600 mt-1" />
    <div>
      <p className="text-sm text-gray-600 font-semibold">แผนก</p>
      <p className="text-base text-gray-800">{data.department_name}</p>
    </div>
  </div>
